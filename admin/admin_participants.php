            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <a href="admin_delete_participant.php?id=<?= $participant['id'] ?>" class="delete-btn" onclick="return confirm('Are you sure you want to delete this participant?')">Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
